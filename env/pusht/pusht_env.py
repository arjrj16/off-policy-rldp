"""
Push-T Environment using PyMunk physics.

Goal: push the gray T-block into the green goal area.
...
class PushTEnv(gym.Env):
    ...
    Observation space: [agent_x, agent_y, block_x, block_y, block_angle] (5D)
    Action space: [target_agent_x, target_agent_y] (2D) in range [0, 512]
